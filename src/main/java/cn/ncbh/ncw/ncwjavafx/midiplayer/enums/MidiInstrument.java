package cn.ncbh.ncw.ncwjavafx.midiplayer.enums;
...
public enum MidiInstrument {;
    ...
    public static final int Accordian = 21;

    public static final int Harmonica = 22;

    public static final int Tango_Accordian = 23;
    ...
    public static final int Lead_2_sawtooth = 81;

    public static final int Lead_3_caliope_lead = 82;

    public static final int Lead_4_chiff_lead = 83;
    ...
    public static final int Lead_8_bass_and_lead = 87;
    ...
    public static final int Agogo_Agogo = 113;
