...
public class Settings {
    ...
    public Settings(boolean _debug, boolean _file_check, int _default_float_length, String _background_mode, boolean _music_is_playing, boolean _continue_playing, String _music_play_mode, boolean _login, int _launch_times, String _default_sf2, int _default_server_port, String _operate_mode) {
